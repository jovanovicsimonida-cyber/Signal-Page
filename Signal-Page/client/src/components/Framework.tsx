...
export function Framework() {
  return (
    <section id="framework" className="py-24 scroll-mt-20 bg-white relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="group p-8 bg-background rounded-xl border border-border hover:border-accent/40 hover:shadow-xl hover:shadow-black/5 hover:-translate-y-1 transition-all duration-300"
            >
