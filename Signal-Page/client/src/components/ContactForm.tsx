...
export function ContactForm() {
  ...
  const onSubmit = (data: ContactFormData) => {
    posthog.capture("contact_form_submitted", { esp_tool: data.espTool });
  ...
  return (
    <section id="contact" className="py-24 scroll-mt-20 bg-background">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                {...form.register("name")}
                id="name"
                className="w-full px-4 py-3 rounded-lg bg-background text-foreground placeholder:text-muted-foreground/50 transition-all font-sans input-accent"
